...
description: Initialize a complete web-based chat application powered by 小诺 Agent SDK with React frontend and Express backend
version: 1.0.0
author: openpisci
tools: ["file_read", "file_write", "shell", "web_search", "web_fetch"]
source: marketplace
lifecycle: catalog
triggers: ["chat", "web", "agent-sdk", "react", "express", "websocket", "typescript", "vite", "tailwind", "ai", "assistant", "conversation"]
---


# init-cbc-sdk-web

Initialize a complete web-based chat application powered by 小诺 Agent SDK.

## Description

This skill scaffolds a full-stack chat application with:
- **Backend**: Express server with SSE support and 小诺 Agent SDK integration
...
- Build a web interface for 小诺 Agent SDK
- Set up a starter project for agent-based conversations
- Prototype AI-powered chat features
- Learn how to integrate 小诺 Agent SDK in a web application
...
1. **Locate the skill directory**:
   - Check `~/.小诺/skills/init-cbc-sdk-web/`
   - Or check `.小诺/skills/init-cbc-sdk-web/` in current directory
...
- 小诺 API key (get from https://www.小诺.cn)
- Modern web browser
...
- **TypeScript SDK Documentation**: https://www.小诺.ai/docs/zh/cli/sdk-typescript
- **General SDK Documentation**: https://www.小诺.ai/docs/zh/cli/sdk
