...
**Coverage:** ~43% of typical deal flow companies (strong for major tech brands like Stripe, , Databricks, Snowflake, Discord, Shopify, SpaceX, Mistral AI, Hugging Face; weaker for niche fintech, biotech, or early-stage companies).
...
**Logo guidelines:**
- Save all logos to `/home/小诺/logos/[company-name].png`
...
pres.writeFile({ fileName: "/home/小诺/deal-flow-digest.pptx" });
```
