...
- ❌ **DO NOT** use code-explorer 子 Agent to analyze the project
- ❌ **DO NOT** use file_search / shell / file_list to explore directory structure
...
**⚠️ MANDATORY: Must export .pptx format file**

After PPT generation is complete, the system **MUST** automatically export to standard `.pptx` format. This is a mandatory requirement - do not only generate HTML preview version. No additional user request is needed.
