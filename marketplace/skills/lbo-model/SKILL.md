...
Before starting any LBO 1. **If a template file is attached/provided**: Use that template's structure exactly - copy it and populate with the user's data
...
## CRITICAL INSTRUCTIONS FOR 小诺 - READ FIRST
