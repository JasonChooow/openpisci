...
fn run_impl() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat::pin_session,
            commands::chat::unpin_session,
            commands::chat::archive_session,
            commands::chat::restore_session,
            commands::chat::list_archived_sessions,
            commands::chat::set_session_workspace,
            commands::chat::set_session_policy_mode,
            commands::chat::set_session_allow_outside_workspace,
            ...
            commands::pool::create_team_task_bundle,
            ...
            commands::pool::rename_pool_session,
            ...
            commands::platform::cloud::get_webdav_config,
            commands::platform::cloud::save_webdav_config,
            commands::platform::cloud::disconnect_webdav,
            commands::platform::cloud::list_webdav_files,
            commands::platform::extras::get_account,
            commands::platform::cloud_account::cloud_sign_in,
            commands::platform::cloud_account::cloud_sign_in_sms,
            commands::platform::cloud_account::cloud_create_captcha,
            commands::platform::cloud_account::cloud_send_sms_code,
            commands::platform::cloud_account::cloud_reset_password,
            commands::platform::cloud_account::cloud_wechat_login,
            commands::platform::cloud_account::cloud_wechat_start_session,
            commands::platform::cloud_account::cloud_wechat_poll_session,
            commands::platform::cloud_account::cloud_wechat_complete_profile,
            commands::platform::cloud_account::cloud_sign_out,
            commands::platform::cloud_account::cloud_account_status,
            commands::platform::cloud_account::sync_cloud_llm_config,
            commands::platform::cloud_account::cloud_usage_request,
            commands::platform::agentos::agentos_status,
            commands::platform::agentos::agentos_bind,
