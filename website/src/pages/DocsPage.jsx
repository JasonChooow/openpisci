...
function DocsHeader() {
  return (
    <header className="site-header docs-site-header">
      <Link className="brand" to="/" aria-label="返回 9Xbot 首页">
      ...
      <div className="header-actions">
        <a className="login-action" href={modelHubLoginUrl}>
          登录
        </a>
        <Link className="header-action" to="/#download">
          下载
        </Link>
      </div>
    </header>
